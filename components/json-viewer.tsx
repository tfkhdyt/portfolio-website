...
export default function JsonViewer() {
  ...
  const formattedJson = useMemo(() => JSON.stringify(jsonData, null, 2), []);
  ...
  const memoizedCard = useMemo(
    ...
    [isMaximized, memoizedCopyButton, memoizedToggleButton, memoizedCardContent]
  );
