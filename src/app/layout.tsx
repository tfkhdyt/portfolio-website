...
export default function RootLayout({
  ...
  return (
    <html lang='en' id='html' className={rubik.className}>
      <body className='transition duration-300 bg-gruvbox-light-bg-primary text-gruvbox-light-text-primary dark:bg-gruvbox-dark-bg-primary dark:text-gruvbox-dark-text-primary'>
        <>
          <Navbar />
